...
namespace basedx11{
	...
	//--------------------------------------------------------------------------------------
	unique_ptr<GSCustomShadowmap, GSCustomShadowmap::Deleter> GSCustomShadowmap::m_Ptr;
	//構築
	GSCustomShadowmap::GSCustomShadowmap() :
		GeometryShader(App::GetApp()->m_wstrRelativeShadersPath + L"GSCustomShadowmap.cso")
	{}
	...
	//--------------------------------------------------------------------------------------
	unique_ptr<GSCustomDraw, GSCustomDraw::Deleter> GSCustomDraw::m_Ptr;
	//構築
	GSCustomDraw::GSCustomDraw() :
		GeometryShader(App::GetApp()->m_wstrRelativeShadersPath + L"GSSimpleBase.cso")
	{}
