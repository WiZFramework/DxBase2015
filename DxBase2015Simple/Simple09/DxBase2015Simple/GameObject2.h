...
namespace basedx11{
	...
	//--------------------------------------------------------------------------------------
	//	class GameObject2 : public Object, public SimpleInterface;
	//	用途: ゲームオブジェクト
	//--------------------------------------------------------------------------------------
	class GameObject2 : public Object, public SimpleInterface{
		weak_ptr<GameStage2> m_GameStgae;
		Vector3 m_Scale;
	...
	public:
		GameObject2(const shared_ptr<GameStage2>& GStage,
	...
	//--------------------------------------------------------------------------------------
	//	class GameStage2 : public StageBase;
	//	用途: ゲームステージ
	//--------------------------------------------------------------------------------------
	class GameStage2 : public StageBase{
		vector<shared_ptr<GameObject2>> m_GameObjectVec;
