...
//定数
const wchar_t* pClassName = L"DxBase2015Class";
const wchar_t* pWndTitle = L"DxBase2015Sample";
...
int MainLoop(HINSTANCE hInstance, HWND hWnd, bool isFullScreen, int iClientWidth, int iClientHeight){
	...
	try{
		...
		while (WM_QUIT != msg.message){
			...
			//キーボードとマウス
			App::GetApp()->GetInputDevice().ResetInputState(App::GetApp()->GetHWnd(), UseKeyVec);
			//更新描画処理
